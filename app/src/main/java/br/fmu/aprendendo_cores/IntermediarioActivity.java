...
public class IntermediarioActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        voltarMenu = findViewById(R.id.voltarMenuInter);
        ...
        back03 = findViewById(R.id.back03);
        ...
        /* Reset botões */
        recarregarBtn = findViewById(R.id.recarregarBtnInter);
        ...
        /* Botão next*/
        next = findViewById(R.id.nextInter);
        // Tornar invisivel 
    ...
    public void opcao1() {
        ...
        if (textR[seq2[0]] == textR[seq1[valCor]]) {
            ...
            if (back02.ImageResource() != R.drawable.intermediario.backRed || back03.ImageResource() != R.drawable.intermediario.backRed) {
